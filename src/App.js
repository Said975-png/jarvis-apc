...
function App() {
  ...
  const jarvisResponses = [
    ...
    "Интересно! Расскаж��те больше о вашем проекте, и я подберу идеальное решение.",
          ...
          <div className="advantages-layout">
            ...
            <div className="advantages-right">
              ...
              <div className="advantage-item">
                ...
                <p>Каждый проект уникален - создаем индивидуальные решения под ваши ��адачи</p>
              </div>
          ...
          <div className="how-it-works-content">
            ...
            <div className="process-section">
              <div className="process-header">
                ...
                <p>Запуск з�� 24 часа без изменения существующего сайта</p>
              </div>
