...
function App() {
  ...
  const jarvisResponses = [
    ...
    "Наши разработчики работают 24/7, чтобы о��есп��чить максимальное качество продукта.",
  ...
  const handlePhoneCall = () => {
    // Можно добавить номер телефона или открыть модальное окно
      ...
      <div className="chat-widget">
        ...
        <div className="widget-buttons-container">
          ...
          <div className="action-button-container">
            <span className="action-label">📞 Позвонить нам</span>
            <button className="action-button phone-button" title="Позвонить">
