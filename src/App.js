...
function App() {
  ...
  const jarvisResponses = [
    ...
    "Хотите узнать бол��ше о наших тарифных планах? Я могу помочь выбрать подходящий вариант.",
          ...
          <div className="advantages-layout">
            ...
            <div className="advantages-right">
              ...
              <div className="advantage-item">
                ...
                <p>Предоставляем гара��тию на все работы и бесплатную техподдержку</p>
              </div>
            ...
            <div className="capabilities-section">
              ...
              <div className="capabilities-grid">
                ...
                <div className="capability-item">
                  ...
                  <p>Мгновенные ответы на вопросы клиентов в любое время, без выходных и пра��дников</p>
                </div>
