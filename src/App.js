        ...
        <div className="container">
          ...
          <div className="how-it-works-content">
            <div className="main-description">
              ...
              <p>Наша система искусственного интеллекта интегрируется в любой интернет-магазин и работает как опытный продавец-консультант, который никогда не устает и всегда готов помочь.</p>
            </div>
