...
function App() {
  ...
  const jarvisResponses = [
    ...
    "Я здесь, чт��бы помочь вам с любыми вопросами о наших услугах и технологиях.",
          ...
          <div className="pricing-grid">
            ...
            <div className="pricing-card pro-plan featured">
              ...
              <div className="plan-features">
                ...
                <div className="feature-item">
                  <div className="feature-dot"></div>
                  <span>Расширенн��я аналитика</span>
                </div>
                <div className="feature-item">
                  <div className="feature-dot"></div>
            ...
            <div className="capabilities-section">
              ...
              <div className="capabilities-grid">
                <div className="capability-item">
                  ...
                  <p>Анализирует историю п��купок, поведение на сайте и предпочтения для точных рекомендаций товаров</p>
                </div>
