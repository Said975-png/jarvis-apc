...
function App() {
  ...
  const jarvisResponses = [
    ...
    "Наши разработчики работают 24/7, чтобы обеспечить максимальное качество прод��кта.",
            ...
            <div className="capabilities-section">
              ...
              <div className="capabilities-grid">
                ...
                <div className="capability-item">
                  ...
                  <p>Мгновенные ответы на вопросы клиент��в в любое время, без выходных и праздников</p>
                </div>
